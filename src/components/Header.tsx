      ...
      Comparateur d'itinéraires Premium
          ...
          <div className="flex items-center 
            ...
            <Button
              ...
              size="icon"
              onClick={toggleTheme}
              className="rounded-full transition-all rtl:ml-1 mr-1
                h-7 w-7               /* Mobile */
            ...
            >
              {mounted && isDark ? (
                <Sun className="h-2 w-2 md:h-5 md:w-5 lg:h-6 lg:w-6 rtl:ml-0 text-amber-500 transition-all" />
              ) : (
                <Moon className="h-2 w-2 md:h-5 md:w-5 lg:h-6 lg:w-6 rtl:ml-0 text-indigo-600 transition-all" />
              )}
            </Button>
          </div>
        </div>
